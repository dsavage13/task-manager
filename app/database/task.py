from app.database import get_db # grabs get_db function


def output_formatter(results):                         # Helper function for formatting the output from tuples into "lists" of "dictionaries"
    out = []
